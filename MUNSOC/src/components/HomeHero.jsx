...
function HomeHero() {
  return (
    <section className=" w-full absolute top-72">
    <section className="flex flex-col justify-center items-center text-white">
        <div className="head text-3xl md:text-7xl mb-11 md:px-11 px-3" data-aos="fade-up" data-aos-duration="2000">Welcome to <span className="hover:text-yellow-500 hover:drop-shadow-[0_1.2px_1.2px_rgba(0,0,0,0.8)]">MUNSOC</span></div>
