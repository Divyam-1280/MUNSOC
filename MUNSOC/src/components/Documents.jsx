...
function Documents() {
  return (
    <div className="documents h-full">
        <div className="w-screen h-24 flex items-center justify-center mt-3">
            <div data-aos="fade-up" data-aos-duration="800"><h1 className="docu-head text lg:text-6xl text-4xl">Documents</h1></div>
        </div>
        <div className="w-screen mt-16 mb-20 flex md:flex-row flex-col justify-around items-center">
