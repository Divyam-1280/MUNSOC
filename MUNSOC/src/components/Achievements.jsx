  ...
  return (
    <section className="h-full achievements flex flex-col">
        <div className="flex justify-between w-full h-[15%]">
            ...
            <div className="flex items-center gap-8 my-12 absolute left-[23%] sm:left-[27%]" data-aos="fade-up" data-aos-duration="800">
        ...
        <div className="achi-hero bg-green-600 mt-28 flex flex-col gap-28 mb-28">
            <AchievementRow1/>
