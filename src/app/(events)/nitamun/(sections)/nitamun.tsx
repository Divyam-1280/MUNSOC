    ...
    <section className="pt-14 sm:pt-20 max-w-[1370px] w-full mx-auto max-lg:px-6">
      ...
      <div className="py-14 mt-16 text-center">
        <BlurFade inView>
          ...
          <p className="text-3xl lg:text-4xl pt-11 tracking-tighter mb-6">Registration is open until <span className="text-primary font-bold">November 28th EOD</span></p>
