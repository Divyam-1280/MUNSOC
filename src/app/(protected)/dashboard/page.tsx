    ...
    <>
      <div className="space-y-4 p-4 sm:pt-8 max-w-7xl w-full">
        ...
        <ul className="gap-y-4 gap-x-6 xl:grid xl:grid-cols-3 xl:grid-rows-1 flex flex-wrap">
          <li>
            <Link href="/create-post" className="h-full bg-secondary/55 border hover:border-primary outline-primary py-2 px-4 rounded-md overflow-auto space-y-3 space-x-6 flex items-center max-w-sm hover:cursor-pointer hover:bg-secondary">
          ...
          <li>
            <Link href="/dashboard/posts" className="h-full bg-secondary/55 border hover:border-primary outline-primary py-2 px-4 rounded-md overflow-auto space-y-3 space-x-6 flex items-center max-w-sm hover:cursor-pointer hover:bg-secondary">
              <div className="bg-background dark:bg-primary dark:text-black p-4 rounded-full antialiased shadow-md dark:shadow-background">
          ...
          <li>
            <Link href="/dashboard/profile" className="h-full bg-secondary/55 border hover:border-primary outline-primary py-2 px-4 rounded-md overflow-auto space-y-3 space-x-6 flex items-center max-w-sm hover:cursor-pointer hover:bg-secondary">
              <div className="bg-background dark:bg-primary dark:text-black p-4 rounded-full antialiased shadow-md dark:shadow-background">
                <LuUser size={34} />
              </div>
              <div className="flex flex-col space-y-2">
