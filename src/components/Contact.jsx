...
function Contact() {
  return (
    <div className="contact w-full h-96">
        <div className="contact-head lg:text-6xl text-4xl w-full h-24 flex items-center justify-center sm:mt-5" data-aos="fade-up" data-aos-duration="800">Contact</div>
