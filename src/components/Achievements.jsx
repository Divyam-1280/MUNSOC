  ...
  return (
    <section className="h-full achievements flex flex-col cursor-default">
        <div className="flex justify-between w-full h-[150px]" id="Achievements" >
            <div>
                <div className="hor-stripe1 mt-4 ml-2 h-[8px] md:w-[200px] w-[100px] " data-aos="fade-right" data-aos-duration="800"></div>
                <div className="ver-stripe1 ml-6 -mt-5 w-[8px] md:h-[176px] h-[100px]"  data-aos="fade-up" data-aos-duration="800"></div>
            </div>
            ...
            <div>
                <div className="hor-stripe2 mt-4 md:mr-2 -ml-16  h-[8px] md:w-[200px] w-[100px]" data-aos="fade-left" data-aos-duration="800"></div>
                <div className="ver-stripe2 md:ml-28 ml-4 -mt-5 w-[8px] md:h-[176px] h-[100px]"  data-aos="fade-up" data-aos-duration="800"></div>
            </div>
        </div>
