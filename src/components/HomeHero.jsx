...
function HomeHero() {
  return (
    ...
    <section className="flex flex-col justify-center items-center text-white">
        ...
        <div className="cont px-11 md:text-xl text-sm">This growth firmly establishes us as one of the elite MUN Clubs in the North East and we are just getting started</div>
    </section>
    </section>
  )
}
