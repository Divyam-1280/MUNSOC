...
function Activity() {
  return (
    <div className="activity h-full">
        <div className="md:text-6xl text-xl flex justify-center mb-20 mt-6 activity-head" data-aos="fade-up" data-aos-duration="800" id="Activiy"><h1 className="text-white">Activity</h1></div>
        <VerticalTimeline className="costum-line font-sans">
            {timelineElements.map((element) => {
                    return(
                        <VerticalTimelineElement key={element.key} icon={<img src={munsoclogoround}/>} contentStyle={{background: '#ffd000'}} contentArrowStyle={{borderRight: '7px solid #ffd000'}}>
